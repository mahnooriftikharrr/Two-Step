...
TwoStep is an adaptive music therapy platform that supports gait rehabilitation for people with Parkinson’s and other motor disorders. By combining the science of rhythmic auditory stimulation with the healing power of music, TwoStep transforms therapy into an engaging, personalized experience. Our prototype captures step rhythms, compares them to therapeutic targets, and uses generative music APIs to adjust tempo, style, and energy in real time—motivating patients to move and reinforcing motor learning. Built with React, it offers a clean interface for patients and therapists, while algorithms track cadence and adapt music seamlessly. Designed to integrate with wearables and patient preferences, TwoStep is scalable, flexible, and has the potential to make rehabilitation more effective, enjoyable, and accessible.
